...
const config: Config = {
  ...
  projectName: 'curvine-doc', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/curvineio/curvine-doc/edit/master/',
          lastVersion: 'current',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Discord',
              href: 'https://discordapp.com/invite/curvine',
            },
            {
              label: 'X',
              href: 'https://x.com/curvine',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Curvine Project Authors.<br/>
                  Open source under Apache License 2.0. Built with Docusaurus.<br/>
                  京ICP备xxxxxxxx号`,
    },
    prism: {
